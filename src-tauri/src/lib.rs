...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::prints::list_print_history,
            commands::prints::add_print_history,
            commands::prints::delete_print_history,
            commands::filament::list_filament_rolls,
            commands::filament::create_filament_roll,
            commands::filament::update_filament_roll,
            commands::filament::adjust_filament_remaining,
            commands::filament::toggle_filament_roll,
